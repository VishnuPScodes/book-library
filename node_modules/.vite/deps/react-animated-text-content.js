...
} from "./chunk-NLZLKLWN.js";
import "./chunk-ZMNPLPWQ.js";
...
// node_modules/react-animated-text-content/dist/react-animated-text-content.development.js
var require_react_animated_text_content_development = __commonJS({
  "node_modules/react-animated-text-content/dist/react-animated-text-content.development.js"(exports, module) {
    (function(g, f2) {
      typeof exports === "object" && typeof module !== "undefined" ? f2(exports, require_react(), (init_esm_browser(), __toCommonJS(esm_browser_exports)), (init_styled_components_browser_esm(), __toCommonJS(styled_components_browser_esm_exports))) : typeof define === "function" && define.amd ? define(["exports", "react", "uuid", "styled-components"], f2) : (g = typeof globalThis !== "undefined" ? globalThis : g || self, f2(g.AnimatedText = {}, g.React, g.uuid, g.styled));
    })(exports, function(exports2, React, uuid, styled) {
      ...
      var renderWords = function(arrayToRender, includeWhiteSpaces) {
        return arrayToRender.map(function(fragment, index) {
          return fragment !== WHITE_SPACE_CODE ? React__default["default"].createElement(AnimatedFragment, { key: index, dangerouslySetInnerHTML: { __html: fragment } }) : includeWhiteSpaces && React__default["default"].createElement(AnimatedFragment, { key: "".concat(index, "&nbsp;"), dangerouslySetInnerHTML: { __html: "&nbsp;" } }) || WHITE_SPACE_CODE;
        });
      };
      ...
      var AnimatedText = function(_a) {
          ...
          var observer = new IntersectionObserver(function(entries, observer2) {
            entries.forEach(function(entry) {
              ...
              if (wrapperRef.current)
                observer2.unobserve(wrapperRef.current);
            });
          }, {
        ...
        var uid = uuid.v4();
        return React__default["default"].createElement(StyledWrapper, __assign({ as: tag, count: type === "words" ? arrayToRender.length : 0, interval: interval || ((_c = animationOptions === null || animationOptions === void 0 ? void 0 : animationOptions.interval) !== null && _c !== void 0 ? _c : DEFAULT_INTERVAL), duration: duration || ((_d = animationOptions === null || animationOptions === void 0 ? void 0 : animationOptions.duration) !== null && _d !== void 0 ? _d : DEFAULT_DURATION), ref: wrapperRef, shouldAnimate, uid, animation: animationOptions, "data-testid": "animated-text" }, props), type === "words" ? renderWords(arrayToRender, includeWhiteSpaces) : renderChars(arrayToRender, interval || ((_e = animationOptions === null || animationOptions === void 0 ? void 0 : animationOptions.interval) !== null && _e !== void 0 ? _e : DEFAULT_INTERVAL), includeWhiteSpaces));
      };
      exports2.WHITE_SPACE_CODE = WHITE_SPACE_CODE;
      exports2["default"] = AnimatedText;
      Object.defineProperty(exports2, "__esModule", { value: true });
    });
  }
});

// node_modules/react-animated-text-content/index.js
var require_react_animated_text_content = __commonJS({
  "node_modules/react-animated-text-content/index.js"(exports, module) {
    if (false) {
      module.exports = null;
    } else {
      module.exports = require_react_animated_text_content_development();
    }
  }
});

// dep:react-animated-text-content
var react_animated_text_content_default = require_react_animated_text_content();
export {
  react_animated_text_content_default as default
};
/*! *****************************************************************************
...
***************************************************************************** */
//# sourceMappingURL=react-animated-text-content.js.map
