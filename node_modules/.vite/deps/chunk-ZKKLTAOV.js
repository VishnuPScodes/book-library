...
function useControllableState(props) {
  ...
  var updateValue = React4.useCallback(function(next2) {
...
function useDimensions(ref, observe) {
  var _React$useState = React4.useState(null), dimensions = _React$useState[0], setDimensions = _React$useState[1];
  var rafId = React4.useRef();
  useSafeLayoutEffect(function() {
    if (!ref.current)
      return void 0;
...
function useOptionalPart(partId) {
  var _React$useState = React4.useState(null), id = _React$useState[0], setId = _React$useState[1];
  var ref = React4.useCallback(function(node2) {
...
function useDisclosure(props) {
  ...
  var _React$useState = React4.useState(props.defaultIsOpen || false), isOpenState = _React$useState[0], setIsOpen = _React$useState[1];
  ...
  var onClose = React4.useCallback(function() {
    if (!isControlled) {
      setIsOpen(false);
    }
    onClosePropCallbackRef == null ? void 0 : onClosePropCallbackRef();
  }, [isControlled, onClosePropCallbackRef]);
  var onOpen = React4.useCallback(function() {
    if (!isControlled) {
      setIsOpen(true);
    }
    onOpenPropCallbackRef == null ? void 0 : onOpenPropCallbackRef();
  }, [isControlled, onOpenPropCallbackRef]);
  var onToggle = React4.useCallback(function() {
...
function useEventListenerMap() {
  var listeners = React4.useRef(/* @__PURE__ */ new Map());
  var currentListeners = listeners.current;
  var add2 = React4.useCallback(function(el, type, listener, options) {
  ...
  var remove = React4.useCallback(function(el, type, listener, options) {
...
var useUpdateEffect = function useUpdateEffect2(effect2, deps) {
  var renderCycleRef = React4.useRef(false);
  var effectCycleRef = React4.useRef(false);
  React4.useEffect(function() {
...
function useFocusOnShow(target, options) {
  ...
  var onFocus = (0, import_react4.useCallback)(function() {
...
function useForceUpdate() {
  var unloadingRef = React4.useRef(false);
  var _React$useState = React4.useState(0), count = _React$useState[0], setCount = _React$useState[1];
...
function useShortcut(props) {
  ...
  var _React$useState = React4.useState([]), keys2 = _React$useState[0], setKeys = _React$useState[1];
...
function useWhyDidYouUpdate(name, props) {
  var previousProps = React4.useRef();
  React4.useEffect(function() {
...
var ColorModeContext = React5.createContext({});
if (__DEV__) {
  ColorModeContext.displayName = "ColorModeContext";
}
function useColorMode() {
  var context = React5.useContext(ColorModeContext);
  if (context === void 0) {
...
function ColorModeProvider(props) {
  ...
  var _React$useState2 = React5.useState(function() {
  ...
  var setColorMode = React5.useCallback(function(value2) {
  ...
  var toggleColorMode = React5.useCallback(function() {
  ...
  var context = React5.useMemo(function() {
    return {
  ...
  return React5.createElement(ColorModeContext.Provider, {
    value: context
  }, children);
}
if (__DEV__) {
...
var DarkMode = function DarkMode2(props) {
  ...
  return React5.createElement(ColorModeContext.Provider, _extends4({
    value: context
  }, props));
};
if (__DEV__) {
...
//# sourceMappingURL=chunk-ZKKLTAOV.js.map
